...
export default function PartnersPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl p-5 sm:p-6">
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-[22px] font-bold leading-tight text-zinc-900">Partners</h1>
      ...
      <div className="mb-4 overflow-hidden rounded-2xl border border-zinc-100 bg-white shadow-[0_1px_4px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)]">
        <div className="border-b border-zinc-100 px-5 py-3">
          <p className="text-[10px] font-semibold uppercase tracking-[0.08em] text-zinc-400">Add Partner</p>
        </div>
        <div className="p-5">
          {addError && (
          ...
          >
            <div>
              <label className="mb-1 block text-[11px] font-medium text-zinc-400">Partner Name *</label>
              <input
                className={inputCls}
